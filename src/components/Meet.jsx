    ...
    <div className="bg-[#F5F7FA] py-10">
      <div className="container mx-auto max-w-[1320px] p-10 grid grid-cols-1 md:grid-cols-2">
        ...
        <div>
          ...
          <ul>
            <li className="flex  flex-col items-center my-10 md:flex-row md:justify-between">
              <img src={clientImgLogo01} alt="" />
              <img src={clientImgLogo02} alt="" />
              <img src={clientImgLogo03} alt="" />
              <img src={clientImgLogo04} alt="" />
              <img src={clientImgLogo05} alt="" />
              <img src={clientImgLogo06} alt="" />
              <li>
                <a href="#" className="text-[#4CAF4F] flex items-center font-bold">
                  Meet all customers <HiOutlineArrowNarrowRight className="ml-1"/>
                </a>
              </li>
            </li>
          </ul>
