...
// ทำเป็น Array เพื่อให้สามารถ loop,map ได้ และทำให้โค๊ดสั้นลง
const clientsImgLogo = [clientImgLogo01, clientImgLogo02, clientImgLogo03, clientImgLogo04, clientImgLogo05, clientImgLogo06, clientImgLogo07];

function Clients() {
  return <div className="container mx-auto max-w-[1320px] py-10 text-center">
