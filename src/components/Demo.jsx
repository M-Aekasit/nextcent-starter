  ...
  return (
    <div className='bg-[#F5F7FA] py-10 flex justify-center text-center'>
        <div>
            ...
            <a href='#' className='inline-flex justify-center items-center mt-5 py-3 px-8  bg-[#4CAF4F] text-white rounded-md'>Get a Demo <HiOutlineArrowNarrowRight className='ml-2'/></a>
        </div>
