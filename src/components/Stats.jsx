  ...
  return (
    <div className="bg-[#F5F7FA] py-10 px-5 md:px-0">
      <div className="container mx-auto max-w-[1320px] grid grid-cols-1 md:grid-cols-2">
        <div>
          <h3 className="text-[2.25rem] font-semibold">
            Helping a local <br />{" "}
        ...
        <div>
          <div className="grid grid-cols-1 md:grid-cols-2 text-center md:text-left">
            <div className="flex flex-col md:flex-row items-center">
              <img className="m-5" src={icon04} alt=""></img>
              <div>
                <h4 className="text-[1.75rem] text-[#4D4D4D] font-bold">
                  2,245,341
                </h4>
                <p>Members</p>
              </div>
            ...
            <div className="flex flex-col md:flex-row items-center">
              <img className="m-5" src={icon05} alt=""></img>
              <div>
                <h4 className="text-[1.75rem] text-[#4D4D4D] font-bold">
                  46,328
                </h4>
            ...
            <div className="flex flex-col md:flex-row items-center">
              <img className="m-5" src={icon06} alt=""></img>
              <div>
                <h4 className="text-[1.75rem] text-[#4D4D4D] font-bold">
                  828,867
                </h4>
            ...
            <div className="flex flex-col md:flex-row items-center">
              <img className="m-5" src={icon07} alt=""></img>
              <div>
                <h4 className="text-[1.75rem] text-[#4D4D4D] font-bold">
                  1,926,436
                </h4>
