...
function Article() {
  return (
    <div className="pt-10 pb-20 text-center">
      <div className="container mx-auto max-w-[1320px]"></div>
      ...
      <p className="text-[#717171]">
        ...
        <br /> read about how our community are increasing their membership
      ...
      <div className="my-10">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          <div className="relative m-5 md:m-0">
            <img className="rounded-xl" src={articleImg01} alt=""></img>
          ...
          <div className="relative m-5 md:m-0">
            <img className="rounded-xl" src={articleImg02} alt=""></img>
          ...
          <div className="relative m-5 md:m-0">
            <img className="rounded-xl" src={articleImg03} alt=""></img>
